functions {
   real[] diff_eq(
    ...
    dydt[1] = -beta1*exp(E*t)*S*E -beta2*exp(I1*t)*S*I1 -beta2*exp(I2*t)*S*I2;
    dydt[2] = (beta1*exp(E*t)*S*E + beta2*exp(I1*t)*S*I1 + beta2*exp(I2*t)*S*I2) - epsilon*E;
